...
;; parameter-related
; TODO(babariviere): missing parameter for single arity fn
; (list_lit
;  .
...
(list_lit
 ...
 .
 (sym_lit) @variable
 (#match? @function.builtin "^(declare|def|definline|definterface|defmacro|defmethod|defmulti|defn|defn-|defonce|defprotocol|defstruct|deftype|ns)$"))
