...
myStartupHook :: X ()
myStartupHook = do
  spawnOnce "feh --bg-fill ~/usr/img/marek-okon-ppk4z65O3MU-unsplash.jpg &"
  -- spawnOnce "picom &"
  spawnOnce
    "trayer --edge top --align right --widthtype request --SetDockType true --SetPartialStrut true --expand true --transparent true --alpha 0 --tint 282c34 --height 18 &"
...
ppCurrentColor = "#98c379"

ppVisibleColor = ppCurrentColor

ppHiddenColor = "#61afef"

ppHiddenNoWindowsColor = "#e06c75"

ppTitleColor = "#abb2bf"

ppUrgentColor = "#be5046"
          ...
          logHook =
            dynamicLogWithPP
              xmobarPP
                { ppOutput = \x ->
                    hPutStrLn xmproc x,
                  ppCurrent = xmobarColor ppCurrentColor "" . wrap "[" "]", -- Current workspace in xmobar
                  ppVisible = xmobarColor ppVisibleColor "", -- Visible but not current workspace
                  ppHidden = xmobarColor ppHiddenColor "" . wrap "*" "", -- Hidden workspaces in xmobar
                  ppHiddenNoWindows = xmobarColor ppHiddenNoWindowsColor "", -- Hidden workspaces (no windows)
                  ppTitle = xmobarColor ppTitleColor "" . shorten 60, -- Title of active window in xmobar
                  ppSep = "<fc=#666666>|</fc>", -- Separators in xmobar
                  ppUrgent = xmobarColor ppUrgentColor "" . wrap "!" "!", -- Urgent workspace
